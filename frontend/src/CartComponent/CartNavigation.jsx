    ...
    <div className="item-center flex w-full justify-between">
      ...
      <div className="flex items-center justify-start gap-2 pr-2">
        ...
        <div className="relative order-2">
          <ShoppingCartIcon className="w-6 text-orange-400" />
          <span className="absolute -top-2 -right-2 flex h-5 w-5 flex-col items-center justify-center rounded-full bg-red-200 p-1 text-center text-[12px] font-bold text-gray-50">
            3
          </span>
        </div>
