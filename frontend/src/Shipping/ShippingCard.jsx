  ...
  return (
    <div className="mb-10 flex flex-col items-start justify-center gap-4 rounded-md bg-white p-4 shadow shadow-gray-950/10">
      ...
      <div className="mt-5 grid grid-cols-2 gap-x-5">
        <Input_Address name="First name" placeholder="Stylish" />
        <Input_Address name="last name" placeholder="Ben" />
      </div>
      <div className="mt-5 grid grid-cols-2 gap-x-5">
        <Input_Address
          name="email"
          ...
          type="email"
        />
        <Input_Address name="phone number" placeholder="0248490032" />
      </div>
      <div className="mt-5 grid grid-cols-3 gap-x-5">
        ...
        <Input_Address name="zip code" placeholder="00223" />
      </div>
      <TextArea />
      <ShippingMethods />
    </div>
  ...
  return (
    <div className="mt-5 flex w-full flex-col items-start justify-center gap-2">
      ...
      <div className="mb-4 grid w-full grid-cols-2 gap-6">
        <Shipping_Method title="free shipping" duration="7-30 Days" price={0} />
        <Shipping_Method
...
function Shipping_Method({ title, duration, price, bg }) {
  return (
    <div
